...
public class GlitchArt extends JFrame
{
	...
	public JTextField txtGIFSpeed;
	public JLabel lblGifSpeed;
	public JSlider gifFrameSlider;
	...
	public GlitchArt()
	{
		...
		gl_imagePreviewPanel.setHorizontalGroup(
				gl_imagePreviewPanel.createParallelGroup(Alignment.LEADING).addGap(0, 511, Short.MAX_VALUE)
						.addComponent(lblImageRender, GroupLayout.DEFAULT_SIZE, 511, Short.MAX_VALUE));
		gl_imagePreviewPanel.setVerticalGroup(gl_imagePreviewPanel.createParallelGroup(Alignment.TRAILING)
		...
		gifFrameSlider = new JSlider();
		gifFrameSlider.setMaximum(1);
		gifFrameSlider.addChangeListener(new ChangeListener()
		{
			public void stateChanged(ChangeEvent e)
			{
				GlitchArt.this.glitchUIManager.changeGIFFrame(GlitchArt.this.gifFrameSlider.getValue());
			}
		});
		gifFrameSlider.setEnabled(false);
		gifFrameSlider.setValue(0);
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGap(18).addComponent(txtPath, GroupLayout.DEFAULT_SIZE, 639, Short.MAX_VALUE)
								.addGap(18)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(imagePreviewPanel, GroupLayout.PREFERRED_SIZE, 511,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(Alignment.LEADING,
												gl_contentPane.createSequentialGroup().addComponent(lblFrame)
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(gifFrameSlider, GroupLayout.DEFAULT_SIZE,
																GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
				.addContainerGap()));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnOpen)
								.addComponent(
										txtPath, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(btnExport))
						.addGap(19)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(imagePreviewPanel, GroupLayout.PREFERRED_SIZE, 390,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												...
												.addGroup(gl_contentPane.createSequentialGroup()
														...
														.addComponent(gifFrameSlider, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))))
								.addComponent(layeredPane, GroupLayout.PREFERRED_SIZE, 1010,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap()));
		...
		gbl_randomPixelGlitchPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_randomPixelGlitchPanel.rowHeights = new int[]
		{ 0, 0 };
		gbl_randomPixelGlitchPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_randomPixelGlitchPanel.rowWeights = new double[]
		...
		// this.glitchUIManager.getjPanelMapping().put(GlitchTypes.RANDOMIZED_PIXEL_SORT,
		// randomPixelPanel);
		...
		lblGifSpeed = new JLabel("GIF Speed:");
		lblGifSpeed.setEnabled(false);

		txtGIFSpeed = new JTextField();
		txtGIFSpeed.setEnabled(false);
		txtGIFSpeed.setColumns(10);
				...
				.addGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_layeredPane.createSequentialGroup().addGroup(gl_layeredPane
								...
								.addGroup(gl_layeredPane.createSequentialGroup()
										.addComponent(jAlgorithmList, GroupLayout.PREFERRED_SIZE, 232,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING)
												...
												.addGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING, false)
														...
														.addComponent(btnReset, GroupLayout.DEFAULT_SIZE, 103,
																Short.MAX_VALUE)
														.addGroup(gl_layeredPane
																.createParallelGroup(Alignment.TRAILING, false)
																.addGroup(Alignment.LEADING, gl_layeredPane
								...
								.addGroup(gl_layeredPane.createSequentialGroup().addGroup(gl_layeredPane
										...
										.addComponent(jAlgorithmSelection, Alignment.LEADING,
										...
										.addGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING, false)
												.addGroup(gl_layeredPane.createSequentialGroup().addGap(6)
														.addComponent(button_3, GroupLayout.PREFERRED_SIZE, 51,
																GroupLayout.PREFERRED_SIZE)
														.addGap(6).addComponent(button_4, GroupLayout.PREFERRED_SIZE,
																71, GroupLayout.PREFERRED_SIZE))
												.addGroup(gl_layeredPane.createSequentialGroup()
														.addPreferredGap(ComponentPlacement.UNRELATED)
														.addComponent(btnClearSelection, GroupLayout.DEFAULT_SIZE,
																GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
								.addContainerGap())
		...
		gl_layeredPane.setVerticalGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING).addGroup(gl_layeredPane
				...
				.addGroup(gl_layeredPane.createParallelGroup(Alignment.BASELINE).addComponent(label_1)
						.addComponent(button_2).addComponent(btnClearSelection))
				.addGap(22)
				.addGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_layeredPane.createSequentialGroup().addGap(1).addComponent(jAlgorithmSelection,
				...
				.addGroup(gl_layeredPane.createParallelGroup(Alignment.BASELINE)
						...
						.addGroup(gl_layeredPane.createSequentialGroup()
								.addGroup(gl_layeredPane.createParallelGroup(Alignment.BASELINE).addComponent(button_5)
										.addComponent(lblGifSpeed))
								.addGroup(gl_layeredPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_layeredPane.createSequentialGroup().addGap(10)
												.addComponent(button_6))
										.addGroup(gl_layeredPane.createSequentialGroup().addGap(1).addComponent(
												txtGIFSpeed, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)))
								.addGap(11).addComponent(btnReset).addGap(8).addComponent(lblSelectionType).addGap(1)
								.addComponent(selectionType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
				.addPreferredGap(ComponentPlacement.RELATED)
				...
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(rgbShiftPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(bitSortPanel, GroupLayout.PREFERRED_SIZE,
						GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addContainerGap(34, Short.MAX_VALUE)));
		GridBagLayout gbl_bitSortPanel = new GridBagLayout();
		gbl_bitSortPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_bitSortPanel.rowHeights = new int[]
		{ 0, 0, 0, 0, 0 };
		gbl_bitSortPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_bitSortPanel.rowWeights = new double[]
		...
		gbl_verticalPixelSortPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_verticalPixelSortPanel.rowHeights = new int[]
		{ 0, 0 };
		gbl_verticalPixelSortPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_verticalPixelSortPanel.rowWeights = new double[]
		{ 0.0, Double.MIN_VALUE };
		...
		gbl_offsetSortPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_offsetSortPanel.rowHeights = new int[]
		{ 0, 0, 0, 0 };
		gbl_offsetSortPanel.columnWeights = new double[]
		{ 0.0, 1.0, Double.MIN_VALUE };
		gbl_offsetSortPanel.rowWeights = new double[]
		...
		offsetScanLines.setModel(new DefaultComboBoxModel(new String[]
		{ "NO", "YES" }));
		...
		gbl_brightnessPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_brightnessPanel.rowHeights = new int[]
		{ 0, 0 };
		gbl_brightnessPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_brightnessPanel.rowWeights = new double[]
		{ 0.0, Double.MIN_VALUE };
		...
		gbl_rgbShiftPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_rgbShiftPanel.rowHeights = new int[]
		{ 0, 0, 0 };
		gbl_rgbShiftPanel.columnWeights = new double[]
		{ 0.0, 1.0, Double.MIN_VALUE };
		gbl_rgbShiftPanel.rowWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		...
		rgbShiftColor.setModel(new DefaultComboBoxModel(new String[]
		...
		gbl_dataAsSoundPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_dataAsSoundPanel.rowHeights = new int[]
		{ 0, 0 };
		gbl_dataAsSoundPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_dataAsSoundPanel.rowWeights = new double[]
		{ 0.0, Double.MIN_VALUE };
		...
		gbl_randomPixelPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_randomPixelPanel.rowHeights = new int[]
		{ 0, 0, 0 };
		gbl_randomPixelPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_randomPixelPanel.rowWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		...
		gbl_pixelSlicePanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_pixelSlicePanel.rowHeights = new int[]
		{ 0, 0 };
		gbl_pixelSlicePanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_pixelSlicePanel.rowWeights = new double[]
		{ 0.0, Double.MIN_VALUE };
		...
		gbl_fractalSortPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_fractalSortPanel.rowHeights = new int[]
		{ 0, 0 };
		gbl_fractalSortPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_fractalSortPanel.rowWeights = new double[]
		{ 0.0, Double.MIN_VALUE };
		...
		gbl_pixelSortPanel.columnWidths = new int[]
		{ 0, 0, 0 };
		gbl_pixelSortPanel.rowHeights = new int[]
		{ 0, 0, 0 };
		gbl_pixelSortPanel.columnWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
		gbl_pixelSortPanel.rowWeights = new double[]
		{ 0.0, 0.0, Double.MIN_VALUE };
